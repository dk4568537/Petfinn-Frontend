  ...
  return (
    <div className="flex flex-col bg-slate-50 items-center text-[#161345] justify-center md:pb-10 p-4">
      <div className="container w-full">
       <Slide><h1 className="flex justify-between pb-14 items-center text-md md:text-6xl lg:text-8xl font-sans font-bold gap-3">
          Save on Bundles{" "}
          <Link href='/product'><button className="hover:scale-105 lg:mt-10 md:text-lg flex justify-center items-center gap-5 border-2 border-gray-800 rounded-full py-1 px-3 md:py-3 md:px-8">
            Shop Now
            <FaArrowRightLong />
          </button></Link>
        </h1></Slide>
