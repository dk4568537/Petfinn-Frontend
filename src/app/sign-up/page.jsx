    ...
    <div className="flex justify-center items-center min-h-screen bg-gray-50">
      <div className="container max-w-xl mx-auto p-8 ">
        <div className="flex flex-col items-center space-y-4">
          <h1 className="text-5xl font-serif text-[#161346] font-bold">Finn</h1>
          <h2 className="text-5xl font-serif text-[#161346] font-bold">Create an Account</h2>
        ...
        <form className="mt-6 space-y-6" onSubmit={handleSubmit}>
         ...
         <div className=" text-center">
            <h1 className="text-[#161346] font-semibold text-md">I have an account, go to <Link href='/login'><span className=" underline text-lg text-blue-700">log in.</span></Link></h1>
            <Link href='#'><h3 className="pt-4 text-orange-500 text-xl">Create your account!</h3></Link>
            <button onClick={()=>router.back()} className="pt-4 text-blue-700 text-lg underline">❮❮ Back to petfinn.com</button>
         </div>
        </form>
      </div>
    </div>
