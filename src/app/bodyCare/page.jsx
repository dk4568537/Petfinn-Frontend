          ...
          >
            ...
            <div className=" items-center flex justify-center flex-col text-center">
              ...
              <button
                ...
                className="hover:scale-105 lg:mt-4 md:text-lg flex justify-center items-center gap-5 border-2 border-gray-800 bg-[#161345] text-white rounded-full py-1 px-3 md:py-3 md:px-8"
              >
                Shop Now
                <FaArrowRightLong />
              </button>
